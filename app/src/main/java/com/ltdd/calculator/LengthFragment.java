...
public class LengthFragment extends Fragment {
    ...
    private void Convert() {
        ...
        txtInches.setText(String.valueOf(r1));
        txtFeet.setText(String.valueOf(r2));
        txtMm.setText(String.valueOf(r3));
        txtCm.setText(String.valueOf(r4));
        txtM.setText(String.valueOf(r5));
        txtKm.setText(String.valueOf(r6));
    }
